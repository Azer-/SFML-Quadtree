...
int main( )
{
    ...
    {
        objects.push_back( Object( rand( ) % ( ( int ) X ), rand( ) % ( ( int ) Y ), rand( ) % objMaxSize + 1, rand( ) % objMaxSize + 1 ) );
    }
    ...
    while ( app.IsOpened( ) )
    {
        ...
        while ( app.GetEvent( event ) )
        {
            ...
            {
                objects.push_back( Object( mousePosition.x, mousePosition.y, rand( ) % objMaxSize + 1, rand( ) % objMaxSize + 1 ) );
            }
        }
        app.Clear( );
